...
% Titel
\def \thesisTitle {Überwindung der Grenzen relationaler Datenbanken in Big-Data-Umgebungen}
...
\def \thesisType {Assignment}             % z.B. Projektarbeit, Bachelorarbeit
\def \module {Advanced Database Technology}                % Modulbezeichnung
\def \degree {Bachelor of Science (B. Sc.)}     % Bildungsabschluss

% Deckblatt
\def \name {Manuel Rettig} % Name des Verfassers
\def \course {WWI23B3} % Kurs
\def \universityAdvisor {Maria Dertinger} % Wissenschaftlicher Betreuer / Dozentin bzw. Dozent
\def \submissionDate {18. März 2025} % Abgabedatum
